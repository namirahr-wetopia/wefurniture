...
class DetailedProductRepository {
  static Future<List<DetailedProductModel>> fetchDetailedProducts() async {
    try {
        ...
        if (response.statusCode == 200) {
            ...
            return data.map((item) {
                ...
                try {
                    return DetailedProductModel.fromJson(Map<String, dynamic>.from(item));
                } catch (e, st) {
